...
ActiveRecord::Schema[7.0].define(version: 2023_07_11_183329) do
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.decimal "promotional_amount", default: "0.0"
    t.decimal "final_amount", default: "0.0"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.decimal "tax_percentage", default: "0.0"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
